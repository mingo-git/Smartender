...
Die Erfolgsquoten einzelner Endpunkte zeigen, dass die meisten Anfragen erfolgreich waren, jedoch 
bei einigen spezifischen Funktionen wie der \\Slot-Registrierung Verbesserungspotenzial besteht (
siehe Abbildung \ref{fig:success_rates}).
...
\begin{tikzpicture}[scale=1]
    \begin{axis}[
        ...
        ylabel={},
        legend style={
            draw=pag!60,   % Red background with black border
