...
\begin{figure}[htbp]
  \centering
	...
	% Knoten
	\node[draw, rectangle, rounded corners, fill=red5, minimum width=3cm, minimum height=1.2cm] (hardware) {Hardware};
	\node[draw, rectangle, rounded corners, fill=red5, minimum width=3cm, minimum height=1.2cm, left of=hardware] (backend) {Backend};
